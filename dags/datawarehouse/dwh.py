from datawarehouse.data_utils import get_conn_cursor, close_conn_cursor, create_chema, create_table, get_video_ids
...
def staging_table():
    ...
    try: 
        ...
        if not ids_in_json:
            logger.warning("API returned no data – skipping delete step")
        else:
            if table_ids: 
